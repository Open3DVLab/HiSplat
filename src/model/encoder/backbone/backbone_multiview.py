...
class BackboneMultiview(torch.nn.Module):
    ...
    def forward(
        ...
        if self.use_epipolar_trans:
            ...
            assert epipolar_kwargs is not None, "must provide camera params to apply epipolar transformer"
            ...
            sampling = epipolar_sampler.forward(features, extrinsics, intrinsics, near, far)
